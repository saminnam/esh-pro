...
const dummy = () => {
  return (
    <>
      <section className="py-10 bg-[#d0ddd0] sm:py-10 lg:py-16">
        <div className="">
          <div className="px-4 sm:px-6 text-gray-800 sm:grid md:grid-cols-4 sm:grid-cols-2 mx-auto">
            ...
            <div className="p-5">
              ...
              <a className="my-3 block" href="/#">
                About <span className="text-teal-600 text-xs p-1"></span>
              </a>
              <a className="my-3 block" href="/#">
                Services <span className="text-teal-600 text-xs p-1">New</span>
              </a>
              <a className="my-3 block" href="/#">
